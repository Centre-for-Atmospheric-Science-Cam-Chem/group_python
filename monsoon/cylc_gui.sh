...
# Change the username to be your own Monsoon username.
...
# Change this to your Monsoon3 username.
USERNAME=firstname.lastname.ext
...
echo "   http://127.0.0.1:${LOCAL_PORT}/suites?user=$USERNAME"
echo "**************************************************************"
